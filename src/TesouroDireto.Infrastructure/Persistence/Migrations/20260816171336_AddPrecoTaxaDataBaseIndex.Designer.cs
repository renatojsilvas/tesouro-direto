...
namespace TesouroDireto.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260816171336_AddPrecoTaxaDataBaseIndex")]
    partial class AddPrecoTaxaDataBaseIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TesouroDireto.Domain.ApiKeys.ApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("TesouroDireto.Domain.Feriados.Feriado", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("TesouroDireto.Domain.Usuarios.Usuario", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("TesouroDireto.Domain.ApiKeys.ApiKey", b =>
                {
                    b.HasOne("TesouroDireto.Domain.Usuarios.Usuario", null)
                        .WithMany()
