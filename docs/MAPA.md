...
12. Observabilidade: métricas por caso de uso (O6) e por dependência externa (O7) ✔️ RESOLVIDAS (2026-07-23); restam **métricas de negócio** (aberto, tarefas 14/O8); Web no Loki/Grafana ✔️ RESOLVIDO (tarefa 17/O2); logs padronizados e painéis de nível corrigidos (tarefas O1/O3/20) (§4).
